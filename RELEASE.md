...
This installs into `~/Applications`, copies ignored local OAuth config into the user's Application Support directory, and attempts LaunchServices/PlugInKit registration for the widget extension.
